...
- **Call Native APIs:** Execute local .NET code directly from JavaScript functions
- **Launch & Manage Applications:** Start, monitor, and interact with desktop applications from a web UI.
